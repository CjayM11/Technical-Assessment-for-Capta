...
const shopProductCard = ({ image, name, description, price, productId, originalPrice, discount }) => {
    ...
    const handleError = () => {
        // Set the fallback image if the main image fails
        setImgSrc("https://via.placeholder.com/300"); // Replace with your fallback image URL
      };
      ...
      const handleAddToCart = async () => {
        ...
        const response = await addToCart(userId, productId, 1); // Add quantity as 1 for now
